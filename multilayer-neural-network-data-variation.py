# Just A Test with urban-sound-mirror-from-repo.npz getted from:
# https://github.com/rickiepark/tfk-notebooks/blob/master/urban-sound-classification/urban_sound.npz
import librosa
import numpy as np
...
# Data
sound_data = np.load('audio-data-extraction/urban-sound-mirror-from-repo.npz')
X_data = sound_data['X']
y_data = sound_data['y']
...
saver.save(session, "./model-ckpt/trained_py_variation_6k.ckpt")
